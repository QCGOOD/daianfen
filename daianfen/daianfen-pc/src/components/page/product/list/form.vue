  ...
  <div style="overflow: auto;">
    ...
    <div class="content">
      ...
      <div v-show="activeIndex === '5'">
        <div class="form">
          <!-- <el-form :model="price" label-width="90px">
            <el-form-item label="限时促销">
              <el-radio-group v-model="price.isPromotion">
                <el-radio :label="false">否</el-radio>
                <el-radio :label="true">是</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="促销价格" v-if="price.isPromotion">
              <el-input size="small" v-model="price.promotionPrice" style="width:400px;"></el-input>
            </el-form-item>
            <el-form-item label="促销时间" v-if="price.isPromotion">
              <el-date-picker size="small" v-model="price.startTime" type="date" placeholder="选择日期" style="width: 170px;"></el-date-picker>
              <span style="display: inline-block; width: 20px; text-align: center;">-</span>
              <el-date-picker size="small" v-model="price.endTime" type="date" placeholder="选择日期" style="width: 170px;"></el-date-picker>
            </el-form-item>
            <el-form-item label="原价">
              <el-input size="small" v-model="price.origPrice" style="width:400px;"></el-input>
            </el-form-item>
            <el-form-item label="现价">
              <el-input size="small" v-model="price.price" style="width:400px;"></el-input>
            </el-form-item>
            <el-form-item label="VIP价">
              <el-input size="small" v-model="price.vipPrice" style="width:400px;"></el-input>
            </el-form-item>
            <el-form-item label="现价最小值">
              <el-input size="small" v-model="price.minPrice" style="width:400px;"></el-input>
            </el-form-item>
            <el-form-item label="现价最大值">
              <el-input size="small" v-model="price.maxPrice" style="width:400px;"></el-input>
            </el-form-item>
            <el-form-item label="库存">
              <el-input size="small" v-model="price.qty" style="width:400px;"></el-input>
            </el-form-item>
            <el-form-item label="星级">
              <el-input size="small" v-model="price.level" style="width:400px;"></el-input>
            </el-form-item>
          </el-form> -->
          <!-- <el-form label-width="90px" :inline="true">
            <el-form-item label="库存">
              <el-input size="small" v-model="price.qty"></el-input>
            </el-form-item>
            <el-form-item label="销量">
              <el-input size="small" v-model="price.saleNumber"></el-input>
            </el-form-item>
          </el-form> -->
