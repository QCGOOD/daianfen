<template>
  <div class="wrap" ref="wrap">
    ...
    <qc-table ref="table" :table-list="showData" :search="searchData" :categoryType="categoryType" url="api/admin/v1/category/page">
 </qc-table>
...
export default {
  ...
  methods: {
    treeByTypeCategory() {
      api.treeByTypeCategory({ type: 1 }).then(res => {
